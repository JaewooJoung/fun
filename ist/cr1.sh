...
# Create CRUX boot entry
cat > /boot/loader/entries/crux.conf <<EOF
title   CRUX Linux
linux   /vmlinuz-linux
...
pkgadd -u base-devel ${CPU_UCODE} networkmanager terminus-font vim efibootmgr \
    ...
    firefox konsole dolphin dosfstools mtools os-prober
